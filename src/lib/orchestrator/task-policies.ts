...
export const TASK_POLICIES: Record<AITask, AITaskPolicy> = {
  ...
  bottleneck_detection: { task: "bottleneck_detection", preferredCapabilities: ["textGeneration", "structuredOutput"], qualityWeight: 0.6, latencyWeight: 0.15, costWeight: 0.15, reliabilityWeight: 0.1, contextStrategy: "compact", maxRetries: 2, cacheStrategy: "persistent", fallbackStrategy: "deterministic_fallback" },
  curriculum_planning: { task: "curriculum_planning", preferredCapabilities: ["textGeneration", "structuredOutput"], qualityWeight: 0.6, latencyWeight: 0.15, costWeight: 0.15, reliabilityWeight: 0.1, contextStrategy: "compact", maxRetries: 2, cacheStrategy: "persistent", fallbackStrategy: "deterministic_fallback" },
  session_replanning: { task: "session_replanning", preferredCapabilities: ["textGeneration", "structuredOutput"], qualityWeight: 0.4, latencyWeight: 0.4, costWeight: 0.1, reliabilityWeight: 0.1, contextStrategy: "recent", maxRetries: 1, cacheStrategy: "none", fallbackStrategy: "deterministic_fallback" },
