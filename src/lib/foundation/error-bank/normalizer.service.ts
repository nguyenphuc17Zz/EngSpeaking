...
> = {
  ...
  taboo_slip: {
    category: "vocabulary",
    canonicalName: "Taboo Word Slip in Circumlocution",
    labelVi: "Lỡ nói từ cấm khi diễn giải vòng",
    descriptionVi: "Buột miệng nói từ mục tiêu bị cấm thay vì dùng khung Genus + Differentia.",
    severity: "major",
    gapType: "production_gap",
  },
  missing_genus: {
    category: "vocabulary",
    canonicalName: "Missing Genus Category in Definition",
    labelVi: "Thiếu khung chủng loại Genus (It's a kind of...)",
    descriptionVi: "Diễn giải thiếu chủng loại khiến người nghe khó đoán khái niệm.",
    severity: "moderate",
    gapType: "retrieval_gap",
  },
  missing_differentia: {
    category: "vocabulary",
    canonicalName: "Missing Differentia Function in Definition",
    labelVi: "Thiếu đặc tính Differentia (công dụng nổi bật)",
    descriptionVi: "Diễn giải thiếu công dụng/đặc điểm phân biệt cốt lõi.",
    severity: "moderate",
    gapType: "retrieval_gap",
  },
  word_stress: {
